CR .( ++++ eForth btc ga144 load file ++++ )
\ ==============================================================
\ todo
\ ==============================================================
\ 20110125 bee add io.e4 and division macro, change filenames
\ 20110116 jwr save eforth.bin to e4okad, extend log title
\ 20110114 bee add see.f  init 'LAST
\ 20101208 bee ga144 16bit, increase image size to 6
...
IADDR @  FSIZE @  S" e4okad/eforth.bin" SAVEFILE
